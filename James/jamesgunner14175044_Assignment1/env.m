classdef env < handle
    ...
    methods (Static)
        ...
        function Run()
            ...
            %place human obj
            h = PlaceObject('MAN.ply', [-1000, 0, 1000]);  % Place the human at the origin
