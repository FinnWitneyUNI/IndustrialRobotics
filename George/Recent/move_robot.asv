classdef move_robot < handle
    methods (Static)
        function robot()
            ...
            global selected_brick iiwa_movement_requested movement_requested emergency_stop_requested;
            while true
                ...
                if ~isempty(selected_brick) 
                  while ~emergency_stop_requested
                    ...
                    %%break for while emergency
                    break; 
                  end
                end
                
                if emergency_stop_requested
                    disp('Emergency stop activated. Halting operations.');
                    break;
                end
